...
<<<<<<< HEAD
	...
	int game_end = 5; //MAP_SIZE*MAP_SIZE*5;
=======
...
<<<<<<< HEAD
						if (Shoot_ID < Ships_Player_2.size() )
						{
							if ( Ships_Player_2[Shoot_ID].Speed > 0)
							{
								Ships_Player_2[Shoot_ID].Speed--;
								for (int i = 0; i < Ships_Player_2[Shoot_ID].Range; i++)
								{
									if (Ships_Player_2[Shoot_ID].Rotation == 1)
									{
										if (MAP[Ships_Player_2[Shoot_ID].x + i + 1][Ships_Player_2[Shoot_ID].y] != '.')
										{
											
										}
									}
									if (Ships_Player_2[Shoot_ID].Rotation == 2)
									{
										if (MAP[Ships_Player_2[Shoot_ID].x - i - 1][Ships_Player_2[Shoot_ID].y] != '.')
										{
									...
									if (Ships_Player_2[Shoot_ID].Rotation == 3)
									{
										if (MAP[Ships_Player_2[Shoot_ID].x][Ships_Player_2[Shoot_ID].y + i + 1] != '.')
										{
											
										}
									}
									if (Ships_Player_2[Shoot_ID].Rotation == 4)
									{
										if (MAP[Ships_Player_2[Shoot_ID].x][Ships_Player_2[Shoot_ID].y - i - 1] != '.')
										{
